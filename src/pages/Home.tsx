    ...
    <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="max-w-3xl lg:w-2/3">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/membership" className="bg-beer-amber text-white text-lg font-bold px-8 py-4 rounded-lg shadow-lg hover:bg-opacity-90 transition transform hover:-translate-y-1 text-center">
                  Join the Club
                </Link>
                <Link to="/sofb" className="bg-transparent border-2 border-white text-white text-lg font-bold px-8 py-4 rounded-lg hover:bg-white hover:text-beer-blue transition transform hover:-translate-y-1 text-center">
            ...
            <div className="lg:w-1/3 flex justify-center">
              <div className="relative">
                ...
                <div className="bg-white p-4 rounded-full shadow-2xl relative">
                  <img src={logo} alt="BURP Logo" className="h-64 w-64 md:h-80 md:w-80 object-contain transform hover:rotate-3 transition duration-500" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-beer-amber">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/membership" className="inline-block bg-beer-brown text-beer-cream text-xl font-bold px-12 py-5 rounded-full shadow-xl hover:scale-105 transition transform text-center">
            Get Started Today
          </Link>
        </div>
      </section>
